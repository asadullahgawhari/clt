<footer class="main-footer text-left"> 
    <strong>CLT 23/10/2025 <a href="https://www.linkedin.com/in/asadullahgawhari/" target="_blank">Asadullah Gawhari</a> & <a href="https://www.facebook.com/najeeb.hosseni" target="_blank">Najib Hussaini</a></strong>
  </footer>
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">تولد غلام غولی چرس</h4>
          ...
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">اپدیت پروفایل علی</h4>
          ...
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">شازیه به خبرنامه پیوست</h4>

                <p>shazia@example.com</p>
              </div>
            </a>
          </li>
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">بخش مالی اجرا شد</h4>
